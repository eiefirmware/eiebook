...
Due to the tendancy of applications to forget that they wrote a message here, this buffer 
is circular and will overwite the oldest message if it needs space for a new message.
